using CarinaLibraryNowAPI.Models;
...
public class BooksController : ControllerBase
{
    ...
    {
         new Book { Id = 1, Title = "How To Avoid An Avoidant", Author = "Fichtee", Genre = "Novel", Available = true, PublishedYear = 2026 },
         new Book { Id = 2, Title = "Grow A Garden", Author = "Iruyuhan", Genre = "FICTION", Available = true, PublishedYear = 2017 }
    };
